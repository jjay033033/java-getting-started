...
public class UrlContent {
	...
	public static void main(String[] args) {
		...
		vo.setUrl("https://get.ss8.fun/");//
		System.out.println(getURLContent(vo ));;
	}
...
//		conn.setRequestProperty("X-Forwarded-For", "121.33.201.170");//Proxy-Client-IP
		conn.setRequestProperty("X-Forwarded-For", "34.217.251.149");//Proxy-Client-IP 34.217.251.149
		conn.setRequestProperty("Proxy-Client-IP", "34.217.251.149");//Proxy-Client-IP
